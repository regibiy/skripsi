        ...
        <div class="d-flex justify-content-between align-items-start col-12 px-0 flex-wrap">
            <div class="d-flex flex-column fs-7 col-lg-5 col-12 border p-2 mb-3 gap-3 text-dark-emphasis rounded">
                ...
                <div class="col-12 fs-7">
                    ...
                    <textarea class="form-control form-control-sm" name="deskripsi" id="deskripsi" cols="30" rows="3" maxlength="255" placeholder="Yuk, konsultasikan buah hati ibu..." required></textarea>
                </div>
                <div class="col-12 fs-7">
                    <label for="gambarPrev" class="form-label form-label-sm">Gambar Saat Ini</label>
                    <button class="btn btn-sm btn-outline-secondary d-block" data-bs-toggle="modal" data-bs-target="#gambar1">
                        <img src="assets/images/1.jpg" alt="gambar activity" class="img-fluid" width="50">
                    </button>
                    <!-- Modal starts-->
                    <div class="modal fade" id="gambar1" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-7" id="exampleModalLabel">Gambar Informasi Kegiatan</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body text-center">
                                    <img src="assets/images/1.jpg" class="img-fluid" width="400" alt="informasi kegiatan" />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 fs-7">
                    ...
                    <input type="file" class="form-control form-control-sm text-dark-emphasis" id="gambar" name="gambar" required>
                </div>
            </div>
            <div class="d-flex flex-column fs-7 col-lg-5 col-12 border p-2 mb-3 gap-3 text-dark-emphasis rounded">
                <div class="col-12 fs-7">
