        ...
        <div class="d-flex justify-content-between align-items-start col-12 px-0 flex-wrap">
            <div class="d-flex flex-column fs-7 col-lg-5 col-12 border p-2 mb-3 gap-3 text-dark-emphasis rounded">
                <div class="col-12 fs-7">
                    ...
                    <input type="text" class="form-control form-control-sm" id="judul" name="judul" maxlength="50" placeholder="x-50-x" required>
                </div>
                <div class="col-12 fs-7">
                    <label for="deskripsi" class="form-label form-label-sm">Deskripsi</label>
                    <textarea class="form-control form-control-sm" name="deskripsi" id="deskripsi" cols="30" rows="3" maxlength="255" placeholder="x-255-x" required></textarea>
                </div>
                <div class="col-12 fs-7">
