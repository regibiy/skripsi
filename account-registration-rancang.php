            ...
            <div class="d-flex justify-content-between col-12 flex-wrap p-2">
                <div class="d-flex flex-column align-items-start col-lg-3 col-12 gap-3 mb-4">
                    ...
                    <div class="col-12 fs-7">
                        ...
                        <input type="number" class="form-control form-control-sm text-dark-emphasis" name="no_kk" id="noKk" placeholder="x-16-x" required autocomplete="off">
                    </div>
                    <div class="col-12 fs-7">
                        <label for="namaDepan" class="form-label form-label-sm text-dark-emphasis">Nama Depan <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-sm text-dark-emphasis" name="nama_depan" id="namaDepan" placeholder="x-30-x" maxlength="30" required autocomplete="off" value="<?= isset($data) ? $data['nama_depan'] : "" ?>">
                    </div>
                    <div class="col-12 fs-7">
                        <label for="namaBelakang" class="form-label form-label-sm text-dark-emphasis">Nama Belakang</label>
                        <input type="text" class="form-control form-control-sm text-dark-emphasis" name="nama_belakang" id="namaBelakang" placeholder="x-30-x" maxlength="30" autocomplete="off" value="<?= isset($data) ? $data['nama_belakang'] : "" ?>">
                    </div>
                    <div class="col-12 fs-7">
                        <label for="tempatLahir" class="form-label form-label-sm text-dark-emphasis">Tempat Lahir <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-sm text-dark-emphasis" name="tempat_lahir" id="tempatLahir" placeholder="x-30-x" maxlength="30" required autocomplete="off" value="<?= isset($data) ? $data['tempat_lahir'] : "" ?>">
                    </div>
                    <div class="col-12 fs-7">
                ...
                <div class="d-flex flex-column align-items-start col-lg-3 col-12 gap-3 mb-4">
                    ...
                    <div class="col-12 fs-7">
                        ...
                        <input type="text" class="form-control form-control-sm text-dark-emphasis" name="pekerjaan" id="pekerjaan" placeholder="x-25-x" maxlength="25" required autocomplete="off" value="<?= isset($data) ? $data['pekerjaan'] : "" ?>">
                    </div>
                    ...
                    <div class="col-12 fs-7">
                        ...
                        <input type="number" class="form-control form-control-sm text-dark-emphasis" name="no_hp" id="noHp" placeholder="x-16-x" required autocomplete="off" <?= isset($data) ? $data['no_hp'] : "" ?>>
                    </div>
                    <div class="col-12 fs-7">
                        <label for="email" class="form-label form-label-sm text-dark-emphasis">Email <span class="text-danger">*</span></label>
                        <input type="email" class="form-control form-control-sm text-dark-emphasis" name="email" id="email" placeholder="x-50-x" required autocomplete="off">
                    </div>
                </div>
                ...
                <div class="d-flex flex-column align-items-start col-lg-3 col-12 gap-3">
                    ...
                    <div class="col-12 fs-7">
                        ...
                        <textarea class="form-control form-control-sm text-dark-emphasis" name="alamat" id="alamat" rows="3" placeholder="x-150-x" maxlength="150" required></textarea>
                    </div>
                    <div class="col-12 fs-7">
                        <label for="rt" class="form-label form-label-sm text-dark-emphasis">RT <span class="text-danger">*</span></label>
                        <input type="number" class="form-control form-control-sm text-dark-emphasis" name="rt" id="rt" placeholder="x-5-x" required autocomplete="off">
                    </div>
                    <div class="col-12 fs-7">
                        <label for="rw" class="form-label form-label-sm text-dark-emphasis">RW <span class="text-danger">*</span></label>
                        <input type="number" class="form-control form-control-sm text-dark-emphasis" name="rw" id="rw" placeholder="x-5-x" required autocomplete="off">
                    </div>
                    <div class="col-12 fs-7">
                        <label for="kelDesa" class="form-label form-label-sm text-dark-emphasis">Kelurahan / Desa <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-sm text-dark-emphasis" name="kel_desa" id="kelDesa" placeholder="x-30-x" maxlength="30" required autocomplete="off">
                    </div>
                    <div class="col-12 fs-7">
                        <label for="kecamatan" class="form-label form-label-sm text-dark-emphasis">Kecamatan <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-sm text-dark-emphasis" name="kecamatan" id="kecamatan" placeholder="x-40-x" maxlength="40" required autocomplete="off">
                    </div>
