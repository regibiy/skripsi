...
if (isset($_GET['treatmentdate']) && isset($_GET['queuenumber']) && isset($_GET['idruang'])) {
    $treatment_date = $_GET['treatmentdate'];
    $queue_number = $_GET['queuenumber'];
    $id_ruang_poli = $_GET['idruang'];
